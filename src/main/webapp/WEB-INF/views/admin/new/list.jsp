											...
											<tbody>
												<c:forEach var="item" items="${model.listResult}">
													<tr>
														...
														<td style="width:300px;"><img alt="" src='<c:url value = '${item.img}'/>' style = "width:300px;height:200px"></td>
														<td>${item.title}</td>
														<td>
															...
															href='${updateNewURL}'><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
														</td>
													</tr>
												</c:forEach>
											</tbody>
